...
const MePage = () => {
  ...
  return (
    <div className="flex flex-col w-full items-center pb-12">
      {/* Banner Section */}
      <div className="w-full h-64 md:h-72 relative group">
        <img
          src="https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?auto=format&fit=crop&w=1600&q=80"
          alt="Banner"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-gradient-to-b from-black/10 to-stone-50/20 group-hover:bg-black/30 transition-colors duration-300"></div>
        <button className="absolute top-6 right-6 bg-white/80 backdrop-blur-md text-stone-700 hover:text-stone-900 px-4 py-2 rounded-xl text-sm font-semibold opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-2 hover:bg-white shadow-sm">
          <ImageIcon size={16} /> Change Cover
        </button>
      </div>

      <div className="w-full max-w-6xl flex flex-col md:flex-row gap-6 px-4 md:px-0 -mt-20 relative z-10">
        ...
        <div className="w-full md:w-1/3 flex flex-col gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-stone-200 p-6 flex flex-col items-center text-center">
            ...
            <p className="text-stone-600 text-sm mb-6">
              Digital nomad, photography enthusiast, and coffee addict.
              Exploring the hidden gems of the world one city at a time.
            </p>
